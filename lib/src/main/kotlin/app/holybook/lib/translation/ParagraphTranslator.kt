 ...
 *
 * This interface is used by IncrementalTranslator to translate paragraphs that don't have reference
...
interface ParagraphTranslator {
   ...
   */
  fun translateParagraph(fromLanguage: String, toLanguage: String, paragraphText: String): String
}
