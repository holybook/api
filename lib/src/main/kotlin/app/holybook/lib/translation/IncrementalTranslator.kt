...
/**
 * An incremental implementation of the Translator interface that translates
 * paragraphs one by one using separate services for translation and text matching.
 *
 * This implementation:
      ...
      val translatedText = when {
        ...
        paragraphWithReference.reference != null -> {
          ...
          if (bestMatch.isNotBlank()) {
            ...
            log.debug("No good match found in reference, translating from scratch for paragraph ${index + 1}")
