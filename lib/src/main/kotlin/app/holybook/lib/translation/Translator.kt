 ...
 *
 * Implementations should handle the translation of text from one language to another using various
 * AI translation models or services.
 */
interface Translator {
   ...
   *
   * @param request The translation request containing source language, target language, and
   *   paragraphs to be translated with optional reference translations
